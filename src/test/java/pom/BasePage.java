    ...
    protected WebDriver driver;
      ...
      //      try {
       ...
       // }
        ...
        public Boolean xpathExistbiometria(String xpath) {
            return elementExistBiometria(driver, By.xpath(xpath));
        }
        ...
        public boolean clickeableByXpath(String xpath) {
            return elementoClickable(driver, By.xpath(xpath));
        }
        public Boolean idExist(String id) {
            return elementExistRicardo(driver, By.id(id));
    }
    protected Boolean elementExistRicardo(WebDriver driver, By by) {
        Boolean retorno = false;
        try {
            WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(Integer.valueOf(40)), Duration.ofSeconds( Integer.valueOf(2)));
            wait.until(ExpectedConditions.presenceOfElementLocated(by));
